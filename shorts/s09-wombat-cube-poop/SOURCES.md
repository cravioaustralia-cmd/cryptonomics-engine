# Image, music and sound sources — s09-wombat-cube-poop
...
|---|---|---|---|
| `music/music.mp3` and `audio/music.mp3` | **Fun and Games** — Ahjay Stelino | Mixkit Stock Music Free Licence | https://mixkit.co/free-stock-music/fun-and-games/ (asset `https://assets.mixkit.co/music/6/6.mp3`) |
...
- `audio/vo.mp3` is the held Atlas en-AU VO copied byte-for-byte from `/workspace/deliverables/s09-wombat-cube-poop/vo-raw/vo-atlas.mp3` (33.792 s); **do not re-record**.
