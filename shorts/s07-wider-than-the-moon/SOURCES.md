# Image, music and sound sources — s07-wider-than-the-moon

Image sources are documented in [`images/SOURCES.md`](images/SOURCES.md). All stills are NASA / USGS / US Gov public-domain or Creative Commons Wikimedia Commons sources; no AI stills are used.
...
- `audio/vo.mp3` is the held Atlas en-AU VO copied byte-for-byte from `/workspace/deliverables/s07-wider-than-the-moon/vo-raw/vo-atlas.mp3` (49.560 s); **do not re-record**.
