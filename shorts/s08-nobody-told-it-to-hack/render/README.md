# Render — s08 Nobody Told It to Hack
...
node shorts/shared/render/contact-sheet.mjs shorts/s08-nobody-told-it-to-hack --every 2.5
node shorts/shared/render/render-episode.mjs shorts/s08-nobody-told-it-to-hack
```
